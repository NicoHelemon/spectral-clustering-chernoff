# Source:
# https://github.com/fraspass/dcsbm/blob/main/dcsbm.py
...
class EGMM:
    ...
    def fit_approximate(self, X, d, transformation, n_init=1):
        ...
        M = GaussianMixture(n_components=self.K, n_init=n_init, random_state=42).fit(self.X)
    ...
    def fit_predict_approximate(self, X, d, n_init=5, transformation=None, use_redundant=True):
        ## Calculate the approximate MLE
        self.fit_approximate(X=X, d=d, n_init=n_init, transformation=transformation)
